...
console.log(isEditing);
  if(isEditing){
    ...
    <label>
        Favourite Genre:
        <input type="text" value={favGenre} onChange={event => setFavGenre(event.target.value)} />  
    </label> 

    <label>
        Favourite Artist:
        <input type="text" value={favArtist} onChange={event => setFavArtist(event.target.value)} />  
    </label> 
    ...
    <Link to={"/mytickets"}><button >View My Tickets</button></Link>
